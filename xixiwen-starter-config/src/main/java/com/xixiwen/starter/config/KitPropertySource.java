 ...
 * @since 1.0.0
 */
public class KitPropertySource extends AbstractKitPropertySource {

	private static final Log log = LogFactory.getLog(KitPropertySource.class);

	private Map<String, String> properties = new LinkedHashMap<>();

	public KitPropertySource(String context, CuratorFramework source) {
