 ...
 * @since 1.0.0
 */
public abstract class AbstractKitPropertySource extends EnumerablePropertySource<CuratorFramework> {

	private String context;

	public AbstractKitPropertySource(String context, CuratorFramework source) {
